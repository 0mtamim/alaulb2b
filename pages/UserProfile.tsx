                          ...
                          <div className="col-span-full border-t border-gray-100 pt-6 mt-2">
                              <div className="flex justify-between items-center">
                                  ...
                                  <div className="flex bg-gray-100 rounded-lg p-1">
                                      <button 
                                        onClick={() => setSecuritySettings({...securitySettings, profileVisibility: 'public'})}
                                      ...
                                      <button 
                                        onClick={() => setSecuritySettings({...securitySettings, profileVisibility: 'private'})}
                  ...
                  >
                        <div className="space-y-4">
                            <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg border border-gray-100">
                               ...
                               <button onClick={() => setNotifications({...notifications, email: !notifications.email})} className={`text-2xl transition-colors ${notifications.email ? 'text-green-500' : 'text-gray-300'}`}>
                            ...
                            <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg border border-gray-100">
                               ...
                               <button onClick={() => setNotifications({...notifications, sms: !notifications.sms})} className={`text-2xl transition-colors ${notifications.sms ? 'text-green-500' : 'text-gray-300'}`}>
                            ...
                            <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg border border-gray-100">
                               ...
                               <button onClick={() => setNotifications({...notifications, push: !notifications.push})} className={`text-2xl transition-colors ${notifications.push ? 'text-green-500' : 'text-gray-300'}`}>
